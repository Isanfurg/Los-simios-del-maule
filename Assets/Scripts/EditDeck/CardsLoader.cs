...
namespace JsonReaderYugi
{
    ...
    class CardsLoader
    {
        private const string pathCards = "Assets/Resources/Cards/";
        private const string pathSmallCards = "Assets/Resources/SmallCards/";
        ...
        public void StartDownload(string path)
        {
            ...
            while ((Line = ReaderObject.ReadLine()) != null)
                ...
                c.cardList = ListOfcards;
                Serializator.SerializeCards(c);
            }
